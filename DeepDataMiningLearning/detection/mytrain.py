...
def get_args_parser(add_help=True):
    ...
    parser.add_argument("--max-images", default=None, type=int, help="maximum number of images to use from dataset (default: None, use all)")
    parser.add_argument(
    ...
    parser.add_argument("--output-dir", default="/content/gdrive/MyDrive/waymooutput", type=str, help="path to save outputs")
